...
class IluvatarBackend(Backend):
    ...
    def is_available(self) -> bool:
        ...
        if IluvatarBackend._available is None:
            try:
                ...
                # Iluvatar GPUs should be detected via device_name
                if (
                    hasattr(current_platform, "device_name")
                    and current_platform.device_name == "iluvatar"
                ):
    ...
    def silu_and_mul(self, x: torch.Tensor, obj=None) -> torch.Tensor:
        ...
        return silu_and_mul_iluvatar(x, obj=obj)
    ...
    def rms_norm(
        ...
        return rms_norm_iluvatar(x, residual, obj=obj)
